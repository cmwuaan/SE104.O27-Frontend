...
import PostDetailPage from '../../pages/management/Post/PostDetailPage';

function Home() {
  const { data, error, isLoading } = useGetListRequest('/homes');
  const [selectedIds, setSelectedIds] = useState([]);
  const { trigger: deleteTrigger, isMutating: isDeleting } = useSendDeleteRequest('/homes', selectedIds, 'ids');
  ...
  const columns = [
    ...
    {
      title: <span className="flex">Address</span>,
      dataIndex: 'address',
      key: 'address',
      width: 200,
      render: (record, value) => {
        console.log(value);
        return <span>{value['address']['address_line']}</span>;
      },
    },
    {
      title: <span className="flex">City</span>,
      dataIndex: 'address',
      key: 'address',
      width: 200,
      render: (record, value) => {
        return <span>{value['address']['city']}</span>;
      },
    },
    {
      title: <span className="flex">Country</span>,
      dataIndex: 'address',
      key: 'address',
      width: 200,
      render: (record, value) => {
        console.log(record['address']);
        return <span>{value['address']['country_name']}</span>;
      },
    },
    {
      title: <span className="flex">District</span>,
      dataIndex: 'address',
      key: 'address',
      width: 200,
      render: (record, value) => {
        console.log(record['address']);
        return <span>{value['address']['district']}</span>;
      },
    },
    {
      title: <span className="flex">Province</span>,
      dataIndex: 'address',
      key: 'address',
      width: 200,
      render: (record, value) => {
        console.log(record['address']);
        return <span>{value['address']['province']}</span>;
      },
    },
    {
      title: <span className="flex">Province</span>,
      ...
      render: (record, value) => {
        console.log(record['address']);
        return <span>{value['address']['ward']}</span>;
      },
    },
    {
